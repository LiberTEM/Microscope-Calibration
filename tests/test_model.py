...
def test_trace_focused():
    ...
    res2 = trace(params=params, scan_pos=PixelYX(y=13, x=7), source_dx=0., source_dy=0.)
...
def test_rotation_direction_0():
    ...
    res = trace(params=params, scan_pos=PixelYX(y=1., x=0.), source_dx=0., source_dy=0.)
