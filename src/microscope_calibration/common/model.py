...
class Parameters4DSTEM:
    ...
    def adjust_detector_rotation(
            self, detector_rotation: float) -> 'Parameters4DSTEM':
        de = self.descan_error
    ...
    def adjust_detector_pixel_pitch(self, detector_pixel_pitch: float) -> 'Parameters4DSTEM':
        de = self.descan_error
